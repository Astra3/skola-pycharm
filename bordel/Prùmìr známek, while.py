...
try:
    ...
    i = int(0)      # počítá, kolikrát cyklus proběhl
    B = int(0)      # sem se přičítají známky
    C = int(zaci)   # od tohoto čísla se odečítají žáci, když chybí a na konci se s ním dělí
    ...
    while i < zaci:
        ...
        try:
            ...
            None
        if A == "n" or A == "" or not 5 >= A >= 1:  # kontroluje podmínky známky a absence
            if A == "n" or A == "":
